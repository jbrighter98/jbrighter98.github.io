    ...
    <div class=center>
      ...
      ?>
            ...
            <div class="container2">
                  <div class="center">
                  <h1 style="font-size: 24px;">Professional Background</h1>
                  <p>
      <?php
                        echo $row["background"];
      ?>
      ...
      ?>
                  ...
                  <div class="center">
                  <h1 style="font-size: 24px;">Current Projects</h1>
                  <p>
      <?php
                        echo $row["projects"];
      ?>
      ...
      ?>
                  ...
                  <div class="center">
                  <h1 style="font-size: 24px;">External Links</h1>
                  <p>
      <?php
                        echo $row["links"];
      ?>
      ...
      ?>
      <div class="center1">
      <button class="button" onclick="window.location.href='prof_profile_edit.php'">Edit</button>
      </div>
  </body>