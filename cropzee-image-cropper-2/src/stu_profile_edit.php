...
<body>
	...
	<form action="stu_profile.inc.php" align="center" method="post" enctype="multipart/form-data">
  		<div class="center">
			...
			<div class="name_container">
				...
				<select id="select" name="year">
					<option hidden=""><?PHP echo ($row)?$row["years"]:'Academic Year'; ?></option>
					<option value="Freshman">Freshman</option>
					<option value="Sophomore">Sophomore</option>
					<option value="Junior">Junior</option>
					<option value="Senior">Senior</option>
				</select>
				<input type="text" id="major" name="major" placeholder="Major" value="<?PHP echo ($row)?$row["major"]:''; ?>" onfocus="this.placeholder = '' offfocus="this.placeholder = ''>
			</div>
		</div>
		<div class="center">
...
<?PHP echo ($row)?$row["aoi"]:''; ?>
		...
		<div class="center">
			...
			<textarea cols="40" rows="5" maxlength="200" id="career" name="career" placeholder="Career Ambitions" style="Width:80%; Padding: 5px; Font-size: 17px; font-family: serif;" onfocus="this.placeholder = '' offfocus="this.placeholder = ''>
<?PHP echo ($row)?$row["career"]:''; ?>
</textarea>
		</div>
		<div class="center">
				<h1 align="left" style="font-size: 24px;">Research Goals</h1>
			<textarea cols="40" rows="5" maxlength="200" id="reason" name="reason" placeholder="Reasons For Wanting to do Research" style="Width:80%; Padding: 5px; Font-size: 17px; font-family: serif;" onfocus="this.placeholder = '' offfocus="this.placeholder = ''>
<?PHP echo ($row)?$row["reason"]:''; ?>
</textarea>
		</div>
