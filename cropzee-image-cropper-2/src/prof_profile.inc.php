...
$sql1 = "UPDATE professor SET name1='$name', email='$email', expertise='$exp', background='$bg', 
...
if (mysqli_affected_rows($conn) > 0) {                                                                
    ...
    $sql2 = "INSERT INTO professor (name1, email, expertise, background, aoi, projects, research, links, imageName, image1) 
    VALUES ('$name', '$email', '$exp', '$bg', '$aoi', '$projects', '$research', '$links', '$imageName', '$image')";
